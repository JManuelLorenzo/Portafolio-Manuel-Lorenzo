...
public class TElementoAB<T> implements IElementoAB<T> {
    ...
    public int ObtenerSiguienteClave(T dato) {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'ObtenerSiguienteClave'");
    }

    @Override
    public int CantidadNodosNivel(int k) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'CantidadNodosNivel'");
    }

    @Override
    public String ListarHojas() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'ListarHojas'");
    }
